...
class Product3<A, B, C>(val a: Sequence<A>, val b: Sequence<B>, val c: Sequence<C>)
    : Sequence<Tuple3<A, B, C>>
{
...
infix fun <A, B, C> Product2<A, B>.product(other: Sequence<C>): Product3<A, B, C>
{
