...
class Product4<A, B, C, D>(val a: Iterable<A>, val b: Iterable<B>, val c: Iterable<C>, val d: Iterable<D>)
...
infix fun <A, B, C, D> Product3<A, B, C>.product(other: Iterable<D>): Product4<A, B, C, D>
{
